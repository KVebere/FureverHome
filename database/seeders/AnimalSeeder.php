    ...
    public function run(): void
    {
        ...
        DB::table('animals')->insert([
            ...
            [
                ...
                'animal_breed' => 'Domestic Shorthair',
                'animal_gender' => 'Female',
                'animal_description' => 'Silly Critter',
                'animal_temperament' => 'Crazy, playful, loveable',
                'good_with_children' => false,
                'good_with_dogs' => false,
                'good_with_cats' => false,
                'can_be_left_alone' => true,
                ...
                'animal_home_type' => 'Apartment',
                'animal_energy_level' => 'Medium',
                'medical_notes' => 'Chipped and spayed',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ...
            [
                ...
                'animal_status' => 'Available',
                'animal_species' => 'Dog',
                'animal_breed' => 'Akita Inu',
                'animal_gender' => 'Female',
                'animal_description' => 'Sleeps 24/7',
                'animal_temperament' => 'Loyal, foodie, cuddlebug',
                'good_with_children' => true,
                'good_with_dogs' => false,
                'good_with_cats' => true,
                'can_be_left_alone' => true,
                ...
                'animal_home_type' => 'House with garden',
                'animal_energy_level' => 'Low',
                'medical_notes' => 'Joint issues',
                'created_at' => now(),
                'updated_at' => now(),
            ],

            // Kombo - Roborovski dwarf hamster
            [
                'shelter_id' => $northernPawsId,
                'animal_name' => 'Detective Kombo',
                'animal_age' => 1,
                'animal_status' => 'Available',
                'animal_species' => 'Other',
                'animal_breed' => 'Roborovski dwarf hamster',
                'animal_gender' => 'Male',
                'animal_description' => 'Speed',
                'animal_temperament' => 'Timid, but will like you if you have food',
                'good_with_children' => false,
                'good_with_dogs' => false,
                'good_with_cats' => false,
                'can_be_left_alone' => true,
